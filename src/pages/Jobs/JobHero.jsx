...
const JobHero = ({ jobs }) => {
  ...
  return (
    <div className='w-full sm:mt-32 '>
      {/* Hero Search Section */}
      <div className='relative border border-lime-200/30 bg-clip-padding bg-opacity-10 bg-lime-100/20 text-center py-16 rounded-2xl backdrop-filter backdrop-blur-sm overflow-hidden'>
        {/* Background Elements */}
        ...
        <div className='relative z-10'>
          <h1 className='text-gray-800 text-3xl md:text-5xl font-bold mb-3'>
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-lime-500 to-emerald-600'>23 Jobs</span> Available Now
          </h1>
          <p className='text-gray-600 font-medium max-w-2xl mx-auto text-lg'>
            Discover your dream role in our hand-picked selection of opportunities
